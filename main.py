...
Because 'current_user_playlists()' has a hard limit at "limit=50" this script isn't able to grab every playlist you have.
...
def get_playlists() -> dict:
    ...
    playlists = sp.current_user_playlists(limit=50) #Hard limit at 50 apparently?
    ...
    print(f"Looking at {len(playlists['items'])} playlists")
